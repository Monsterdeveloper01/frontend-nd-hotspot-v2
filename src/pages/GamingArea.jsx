            ...
            <div className="relative z-10">
                ...
                <header className="max-w-7xl mx-auto px-8 pt-10 pb-20 text-center lg:text-left">
                    <div className="inline-flex items-center gap-3 px-4 py-2 bg-purple-600/10 border border-purple-500/20 rounded-full mb-8">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-[0.2em] text-purple-400">Extreme Low Latency Enabled</span>
                    </div>
                    ...
                    <p className="text-slate-400 font-bold text-lg max-w-2xl leading-relaxed">
                        Unleash your potential with our high-priority bandwidth tiers. Zero lag, dedicated pipes, and unlimited data for the ultimate gaming experience.
                    </p>
                </header>
                ...
                <section className="max-w-7xl mx-auto px-8 pb-32">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {loading ? (
                            [1, 2, 3].map(i => (
                                <div key={i} className="h-96 bg-white/5 border border-white/10 rounded-[40px] animate-pulse"></div>
                            ))
                        ) : plans.length > 0 ? plans.map((plan) => (
                            <div key={plan.id} className="group relative bg-[#121217] border border-white/5 rounded-[40px] p-10 hover:border-purple-500/50 transition-all duration-500 hover:-translate-y-2 overflow-hidden shadow-2xl">
                                {/* Card Glow */}
                                ...
                                <div className="relative z-10">
                                    <div className="flex justify-between items-start mb-10">
                                        ...
                                        <div className="text-right">
                                            <span className="text-[10px] font-black uppercase tracking-widest text-slate-500 block mb-1">Access Level</span>
                                    ...
                                    <div className="space-y-4 mb-10">
                                        <div className="flex justify-between items-center bg-white/5 px-6 py-4 rounded-2xl border border-white/5">
                                            ...
                                            <span className="font-black text-xs uppercase tracking-tighter">Extreme High</span>
                                        </div>
                                        <div className="flex justify-between items-center bg-white/5 px-6 py-4 rounded-2xl border border-white/5">
                                            <div className="flex items-center gap-3 text-slate-400 font-black uppercase text-[10px] tracking-widest">
