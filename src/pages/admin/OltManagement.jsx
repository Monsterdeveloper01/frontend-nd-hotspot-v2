                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input 
                                        ...
                                        className="w-full px-5 py-4 bg-admin-base border border-admin-border rounded-2xl font-bold font-mono tracking-widest focus:ring-2 focus:ring-blue-500 outline-none transition-all" 
                                        placeholder="••••••••"
                                        required
                                    />
                                </div>
